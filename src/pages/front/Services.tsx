...
const serviceItem: ServiceItem[] = [
  {
    ...
    name: "深層清潔護理",
    description:
      "透過溫和去角質、毛孔清潔與粉刺代謝方法，恢復肌膚潔淨與呼吸力。",
